    ...
    public class MCellCollection
    {
        ...
        public Dictionary<int, MCell>.ValueCollection Items
        {
            get
            {
                ...
                //TODO: в стороннем приложении выбрасывается искючение "Коллекция была модифицирована"
                //Хотя моифицирования в коде нет.
                //Надо наверно тут копировать ячейки в список или массив и отдавать уже массив.
                //Раз такая странная хрень происходит.
            }
        }
