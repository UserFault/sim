...
#region Properties
        ...
        /// <summary>
        /// Служебная внутренняя функция
        /// Cell (saving) mode: Compact, Normal, DelaySave, Temporary
        /// </summary>
        /// <param name="val"></param>
        public abstract void __setCellMode(MCellMode val);
        /// <summary>
        /// Служебная внутренняя функция
        /// Cell creation timestamp
        /// </summary>
        /// <param name="val"></param>
        public abstract void __setCreaTime(DateTime val);
        /// <summary>
        /// Служебная внутренняя функция
        /// Last modification timestamp
        /// </summary>
        /// <param name="val"></param>
        public abstract void __setModiTime(DateTime val);
        #endregion
