...
#region Properties
        ...
        public void SolutionOpen(string projectFilePath)
        {
            ...
            m_dataLayer = MDbAdapterBase.LoadDbAdapter(this, projectInfo.DatabaseType);//этот тип данных должен быть взят из объекта MSolutionInfo
...
#region New project functions - 210213 - уточнение прототипов функций
        ...
        public void SolutionCreate(string rootFolder, MSolutionInfo info)
        {
            try
            {
                ...
                MDbAdapterBase db = MDbAdapterBase.LoadDbAdapter(this, info.DatabaseType);
        ...
        public static void SolutionDelete(string projectFilePath)
        {
            ...
            //{
                MDbAdapterBase db = MDbAdapterBase.LoadDbAdapter(null, pfile.DatabaseType);
...
#region Cell functions
        ...
        internal MCell S1_intCreateCell(MCellMode mode)
        {
            ...
            {
                result = new MCellA(cell.CellID);//copy cell id value
            }
            else result = cell;
