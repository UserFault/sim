...
namespace RenewTests2017
{
    ...
    /// Без тестов дело идет медленно и вообще, неуверенно как-то.
    /// </summary>
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TestMakeInitialStructure("C:\\Temp\\TestSolution\\TestSolution.tapj");


            return;
        }

        private static void TestMakeInitialStructure(string p)
        {
            try
            {
                ConsoleWriteLine("Initial structure test started");
                ...
                SolutionHelper.СоздатьАккаунтПользователя(d, MCellMode.Normal, "ИванПетров", "Тестовый аккаунт пользователя");
