...
namespace MsSql2005DbAdapter
{
    /// <summary>
    /// Адаптер БД MsSql2005
    /// Транзакции пока не поддерживаются.
    /// </summary>
    public class MsSql2005DbAdapter: MDbAdapterBase
    {
...
#region *** Fields ***
        ...
        /// </summary>
        public MsSql2005DbAdapter(MEngine engine):base(engine)
        {
...
#region *** Функции создания и изменения БД ***
        ...
        public override void DatabaseClear()
        {
            ...
            this.TableDelete(MsSql2005DbAdapter.CellTableName);
            this.TableDelete(MsSql2005DbAdapter.LinkTableName);
            this.TableDelete(MsSql2005DbAdapter.ContainerTableName);
...
#region *** Функции ячеек ***
        ...
        {
            return this.getRowCount( MsSql2005DbAdapter.CellTableName, "id");
...
#region *** Функции связей ***
        ...
        public override int LinkInsertGetId(Mary.MLink link)
        {
            LinkInsert(link);
            //вернуть ид связи 
            int id = this.getTableIdentity(MsSql2005DbAdapter.LinkTableName);
            link.TableId = id;
        ...
        {
            return this.getRowCount(MsSql2005DbAdapter.LinkTableName, "id");
